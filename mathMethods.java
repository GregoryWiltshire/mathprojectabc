...
public class mathMethods
{
    ...
    public static boolean onLine(double P1[], double P2[], double V[])
    {
        ...
        int crossProduct = (int)dotProduct(check,V);
        if(crossProduct==0)
            return true;
        else
            return false;
    ...
    public static String planeEquation(double P1[], double P2[], double V[])
    {
        ...
        //Cross product
        normalVector[0]=(V[1]*S[2])-(S[1]*V[2]);
        normalVector[1]=-((V[0]*S[2])-(S[0]*V[2]));
        normalVector[2]=(V[0]*S[1])-(S[0]*V[1]);
